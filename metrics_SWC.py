...
def get_metrics():
    # Données fixes
    shares_basics = 351_919_127
    shares_fully_diluted = 361_326_473
    btc_held = 2750
    btc_yield_ytd = 0
    q2_yield = 204.9
    debt_btc = 12000000
    ...
    rows = [
        ...
        ("2025-04-30", 3.44, 70930, 5.74),
        ("2025-05-07", 4.85, 71340, 10.59),
        ("2025-05-14", 8.61, 75494, 19.20),
        ("2025-05-20",16.42, 77954, 35.62),
        ("2025-05-23",23.09, 80121, 58.71),
        ("2025-05-29",24.53, 81533, 83.24),
        ("2025-06-05",39.52, 77698,122.76),
        ("2025-06-10",45.32, 77435,168.08),
        ("2025-06-13",74.27, 80450,242.34),
        ("2025-06-19",104.28,77753,346.63),
        ("2025-06-24",196.90,77122,543.52),
        ("2025-07-01",230.05,78104,773.58),
        ("2025-07-07",226.42,78932,1000.00),
        ("2025-07-11",275.00,79563,1275.00),
        ("2025-07-16",325.00,83525,1600.00),
        ("2025-07-25",225.00,87096,1825.00),
        ("2025-07-30",225.00,88482,2050.00),
        ("2025-08-08",50.00, 86650,2100.00),
        ("2025-08-12",295.00,89000,2395.00),
        ("2025-08-28",45.00,82919,2440.00),
        ("2025-09-10",30.00,83405,2470.00),
        ("2025-09-23",55.00,83882,2525.00),
        ("2025-10-07",25.00,92009,2550.00),
        ("2025-10-13",100.00,90764,2650.00),
        ("2025-10-21",10.00,83258,2660.00),
        ("2025-11-04",4.00,82763,2664.00),
        ("2026-01-22",10.00,67210,2674.00),
        ("2026-02-11",15.00,52385,2689.00),
        ("2026-03-02",3.00,47871,2692.00),
        ("2026-03-10",3.00,48764,2695.00),
        ("2026-04-14",11.00,53901,2706.00),
        ("2026-04-24",44.00,57081,2750.00),
    ]
